...
public class Encryption extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Encrypt By Ceaser technique");
        setResizable(false);
        ...
        jPanel1.add(encrypt);
        encrypt.setBounds(120, 280, 130, 60);
        ...
        try {
            ...
            if (!check.isEmpty()) {
                ...
                for (int i = 0; i < result.length; i++) {
                    int index_want_to_encrypt = Plaintext.indexOf(result[i]);
                    output.add(Ciphertext.get(index_want_to_encrypt));
                }
                ...
                JOptionPane.showMessageDialog(null, "<html><body>your decrypted message is : <p style='width: 200px;'>" + cipher_text + "</p> with : <p  style='width: 200px;'>" + shift_clone + "</p></body></html>", "cipher message", JOptionPane.INFORMATION_MESSAGE);
