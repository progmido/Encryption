 ...
 * @author Abuelhassan
 */
public class double_transporation_encryption extends javax.swing.JFrame {

    /**
     * Creates new form ceaser_encryption
     */
    public double_transporation_encryption() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(double_transporation_encryption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new double_transporation_encryption().setVisible(true);
            }
        });
    }
